# Session 16 Assignment - Holder Behavior
...
```
exchange_inflow_qa_pairs.json
exchange_outflow_qa_pairs.json
exchange_net_position_change_qa_pairs.json
exchange_reserve_qa_pairs.json
whale_wallet_activity_qa_pairs.json
```
...
4. **Notify:** Place "session-16-complete.txt" flag file
...
- Sessions Complete: 16/44
- Indicators Complete: 80/227 (35.2%)
- Q&A Pairs: ~6080 total
...
- Session 17 assignment (next 5 indicators)
- Progress update

**Session 17 Preview:** TBD - Next indicator set
