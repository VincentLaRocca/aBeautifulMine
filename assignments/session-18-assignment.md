# Session 18 Assignment - Mining & Staking Metrics
...
```
hash_ribbons_qa_pairs.json
difficulty_adjustment_qa_pairs.json
mining_revenue_qa_pairs.json
miner_net_position_change_qa_pairs.json
miner_to_exchange_flow_qa_pairs.json
```
...
4. **Notify:** Place "session-18-complete.txt" flag file
...
- Sessions Complete: 18/44
- Indicators Complete: 90/227 (39.6%)
- Q&A Pairs: ~6840 total
...
- Session 19 assignment (next 5 indicators)
- Progress update

**Session 19 Preview:** TBD - Next indicator set
