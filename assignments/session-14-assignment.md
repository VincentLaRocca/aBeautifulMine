# Session 14 Assignment - HODL Metrics
...
Generate comprehensive Q&A datasets for HODL Metrics using **ultra_deep_research** methodology.

---

## 📊 Session 14 Indicators

**Category:** On-Chain Indicators
**Subcategory:** HODL Metrics

### The 5 Indicators:

1. **Liveliness (ratio of CDD to total coin days)**
...
```
liveliness_ratio_of_cdd_to_total_coin_days_qa_pairs.json
entity_adjusted_dormancy_flow_qa_pairs.json
mvrv_ratio_market_value_to_realized_value_qa_pairs.json
nupl_net_unrealized_profit_loss_qa_pairs.json
sopr_spent_output_profit_ratio_qa_pairs.json
```
...
4. **Notify:** Place "session-14-complete.txt" flag file
...
These 5 indicators from HODL Metrics provide complementary analysis approaches for cryptocurrency markets.

---

## 📊 Progress Tracking

**Project Status After Session 14:**
- Sessions Complete: 14/44
- Indicators Complete: 70/227 (30.8%)
- Q&A Pairs: ~5320 total
- Categories: Derivatives, HODL Metrics
...
- Session 15 assignment (next 5 indicators)
- Progress update

**Session 15 Preview:** TBD - Next indicator set
