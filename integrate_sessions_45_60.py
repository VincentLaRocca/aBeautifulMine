...
print("="*70)
print("PHASE 2 BATCH 1: INTEGRATING SESSIONS 45-60")
print("="*70)
...
target_sessions = list(range(45, 61))
...
for target_session in target_sessions:
    ...
    for idx, qa in enumerate(qa_pairs, 1):
        ...
        if not question or not answer:
            # Try alternate structure with 'content' field
    ...
    # Commit every 5 sessions to avoid losing progress
...
# Final report
print(f"\n{'='*70}")
print("PHASE 2 BATCH 1 INTEGRATION COMPLETE")
print(f"{'='*70}")
...
# Calculate coverage through session 60
cursor.execute('SELECT COUNT(DISTINCT session_number) FROM crypto_indicators WHERE session_number BETWEEN 1 AND 60')
sessions_1_60 = cursor.fetchone()[0]
print(f"  Sessions 1-60 coverage: {sessions_1_60}/60 ({(sessions_1_60/60*100):.1f}%)")

conn.close()

print("\n" + "="*70)
print("PHASE 2 BATCH 1 SUCCESS - READY FOR BATCH 2")
print("="*70)
