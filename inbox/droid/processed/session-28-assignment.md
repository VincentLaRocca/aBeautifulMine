# Session 28 Assignment - Institutional & Whale Activity
...
Generate comprehensive Q&A datasets for Institutional & Whale Activity using **ultra_deep_research** methodology.

---

## 📊 Session 28 Indicators

**Category:** Market Sentiment Indicators
**Subcategory:** Institutional & Whale Activity

### The 5 Indicators:

1. **Institutional Holdings**
2. **Whale Alert Transactions**
3. **CME Futures Open Interest**
4. **CME Gaps**
...
```
institutional_holdings_qa_pairs.json
whale_alert_transactions_qa_pairs.json
cme_futures_open_interest_qa_pairs.json
cme_gaps_qa_pairs.json
total_value_locked_tvl_qa_pairs.json
```
...
```json
{
  ...
  "category": "institutional_&_whale_activity",
...
4. **Notify:** Place "session-28-complete.txt" flag file
...
These 5 indicators from Institutional & Whale Activity provide complementary analysis approaches for cryptocurrency markets.

---

## 📊 Progress Tracking

**Project Status After Session 28:**
- Sessions Complete: 28/44
- Indicators Complete: 140/227 (61.7%)
- Q&A Pairs: ~10640 total
- Categories: Derivatives, Institutional & Whale Activity
...
- Session 29 assignment (next 5 indicators)
- Progress update

**Session 29 Preview:** TBD - Next indicator set
