# Session 11 Assignment - Network Activity Metrics
...
2. **Network Hash Rate (PoW chains)**
3. **Network Staking Rate (PoS chains)**
...
```
transaction_velocity_qa_pairs.json
network_hash_rate_pow_chains_qa_pairs.json
network_staking_rate_pos_chains_qa_pairs.json
circulating_supply_qa_pairs.json
total_supply_qa_pairs.json
```
...
4. **Notify:** Place "session-11-complete.txt" flag file
...
**Project Status After Session 11:**
- Sessions Complete: 11/44
- Indicators Complete: 55/227 (24.2%)
- Q&A Pairs: ~4180 total
...
- Session 12 assignment (next 5 indicators)
- Progress update

**Session 12 Preview:** TBD - Next indicator set
