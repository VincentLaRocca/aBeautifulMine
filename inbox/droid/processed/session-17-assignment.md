# Session 17 Assignment - Holder Behavior
...
Generate comprehensive Q&A datasets for Holder Behavior using **ultra_deep_research** methodology.

---

## 📊 Session 17 Indicators

**Category:** On-Chain Indicators
**Subcategory:** Holder Behavior

### The 5 Indicators:

1. **Large Transaction Volume (>$100K)**
2. **Binary Coin Days Destroyed (CDD)**
3. **Supply Held by Top Addresses (Top 1%)**
4. **Supply Held by Top Addresses (Top 10%)**
5. **Gini Coefficient (wealth distribution)**
...
```
large_transaction_volume_>$100k_qa_pairs.json
binary_coin_days_destroyed_cdd_qa_pairs.json
supply_held_by_top_addresses_top_1%_qa_pairs.json
supply_held_by_top_addresses_top_10%_qa_pairs.json
gini_coefficient_wealth_distribution_qa_pairs.json
```
  ...
  "qa_pairs": [
    {
      ...
      "created_date": "2025-11-02 HH:MM:SS",
      "indicator": "indicator_slug",
      "category": "holder_behavior",
      "session": 17
    }
...
### 1. Large Transaction Volume (>$100K)
- Focus on: [Key characteristics and use cases]
- Cover: [Important parameters and settings]
- Highlight: [Crypto-specific applications]
...
1. **Generate all 5 JSON files** using ultra_deep_research
2. **Place files in:** `inbox/droid/`
3. **Create completion report:** Brief markdown summary
4. **Notify:** Place "session-17-complete.txt" flag file

**That's it!** Import and refinement will be handled by orchestrator.

---

## 🎓 Context: Why These 5 Together?

These 5 indicators from Holder Behavior provide complementary analysis approaches for cryptocurrency markets.
...
- Sessions Complete: 17/44
- Indicators Complete: 85/227 (37.4%)
- Q&A Pairs: ~6460 total
- Categories: Derivatives, Holder Behavior
...
- Session 18 assignment (next 5 indicators)
- Progress update

**Session 18 Preview:** TBD - Next indicator set
...
**Onwards to Session 17!**

---

**Assignment Created:** 2025-11-02
