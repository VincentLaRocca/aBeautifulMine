# Session 25 Assignment - Funding & Derivatives
...
2. **Open Interest (futures/options)**
3. **Long/Short Ratio**
4. **Options Put/Call Ratio**
5. **Liquidation Data (long liquidations)**
...
```
funding_rates_perpetual_futures_qa_pairs.json
open_interest_futures_options_qa_pairs.json
long_short_ratio_qa_pairs.json
options_put_call_ratio_qa_pairs.json
liquidation_data_long_liquidations_qa_pairs.json
```
...
4. **Notify:** Place "session-25-complete.txt" flag file
...
- Sessions Complete: 25/44
- Indicators Complete: 125/227 (55.1%)
- Q&A Pairs: ~9500 total
...
- Session 26 assignment (next 5 indicators)
- Progress update

**Session 26 Preview:** TBD - Next indicator set
