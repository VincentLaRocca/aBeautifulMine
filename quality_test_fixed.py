...
if structure_issues == 0:
    print("[PASS] PASS: All sampled pairs have required fields")
else:
    print(f"[FAIL] FAIL: {structure_issues} pairs missing required fields")
...
if empty_questions == 0 and empty_answers == 0:
    print("\n[PASS] PASS: No empty questions or answers")
else:
    print(f"\n[FAIL] FAIL: {empty_questions} empty questions, {empty_answers} empty answers")
...
if len(duplicates) > 0:
    ...
    print("[PASS] PASS: No duplicate questions")
...
if has_crypto_terms / len(qa_pairs) > 0.8:
    print("\n[PASS] PASS: High crypto-specific content (>80%)")
else:
    print(f"\n[WARN] WARNING: Lower crypto-specific content ({has_crypto_terms/len(qa_pairs)*100:.1f}%)")
...
if quality_report['quality_score'] >= 90:
    print("[PASS] EXCELLENT: Data ready for production integration")
    integration_ready = True
elif quality_report['quality_score'] >= 75:
    print("[PASS] GOOD: Data acceptable for integration with minor cleanup")
    integration_ready = True
elif quality_report['quality_score'] >= 60:
    print("[WARN] FAIR: Data needs cleanup before integration")
    integration_ready = False
else:
    print("[FAIL] POOR: Data requires significant cleanup")
    integration_ready = False
